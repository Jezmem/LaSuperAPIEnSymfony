 ...
 */
final class Version20250126164233 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE video_game (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, release_date DATE NOT NULL, description LONGTEXT NOT NULL, editor_id INT NOT NULL, category_id INT DEFAULT NULL, INDEX IDX_24BC6C506995AC4C (editor_id), INDEX IDX_24BC6C5012469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
